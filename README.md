# RedmineCLI [![Build Status](https://travis-ci.org/a11n/RedmineCLI.svg)](https://travis-ci.org/pedrobaracho/RedmineCLI) [![Coverage Status](https://coveralls.io/repos/pedrobaracho/RedmineCLI/badge.svg?branch=master)](https://coveralls.io/r/pedrobaracho/RedmineCLI) [![npm version](http://img.shields.io/npm/v/redmine-cli.svg?style=flat)](https://www.npmjs.com/package/redmine-cli) [![npm license](https://img.shields.io/npm/l/redmine-cli.svg)](https://www.npmjs.com/package/redmine-cli)
